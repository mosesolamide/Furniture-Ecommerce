        ...
        <div className='flex flex-col md:flex-row gap-16 md:gap-5 justify-center items-center mt-10'>
            <div className="max-w-85">
                ...
                <p className='text-gray-500 text-xs mt-3'>
                    by <b className='text-gray-800'> Kristin Watson </b> on <b className='text-gray-800'>Dec 19, 2021</b>
                </p>
            </div>
            ...
            <div className="max-w-85">
                ...
                <p className='text-gray-500 text-xs mt-3'>
                    by <b className='text-gray-800'> Robert Fox </b> on <b className='text-gray-800'>Dec 15, 2021</b>
                </p>
            </div>
